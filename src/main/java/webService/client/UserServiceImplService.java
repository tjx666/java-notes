 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://webService/", wsdlLocation = "http://localhost:9001/webService/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://webService/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/webService/users?wsdl");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://webService/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
